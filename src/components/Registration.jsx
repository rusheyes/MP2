...
const RegistrationComponent = () => {
  ...
  const handleRegister = () => {
    ...
    setUserData({ ...userData, registration: newUser });

    localStorage.setItem('userData', JSON.stringify({ ...userData, registration: newUser }));
        ...
        <Col md={6}>
          <div className="registration-form">
            ...
            <Form>
              ...
              <Form.Control
                type="file"
                accept=".pdf, .jpg, .png" /* Adjust accepted file formats as needed */
              ...
              <Button className="groupdes" variant="primary" onClick={handleRegister}>
                Register
              </Button>
            </Form>
          </div>
